...
const char *ssid = "Internet2.4";  // Nome da rede Wi-Fi (substitua pelo nome da sua rede Wi-Fi)
const char *password = "Senha2.4"; // Senha da rede Wi-Fi (substitua pela senha da sua rede Wi-Fi)
